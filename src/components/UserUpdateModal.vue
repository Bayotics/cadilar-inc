<template>
  <div>
    <button @click="isOpen = !isOpen" style = "color: #209cee; border: 0px" id = "but" class="button is-primary is-outlined m-t-sm">Update Info</button>
    <div :class="['modal', {'is-active': isOpen}]">
      ...
      <div class="modal-card">
        ...
        <footer class="modal-card-foot">
          <button @click="emitUser" style="background-color: #209cee" class="button is-success">Save changes</button>
